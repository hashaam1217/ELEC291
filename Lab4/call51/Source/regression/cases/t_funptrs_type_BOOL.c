...
typedef void (*ONEARGFUNPTR)(BOOL) REENTRANT;
typedef long int (*FOURARGFUNPTR)(char, char, long int, long int) REENTRANT;
typedef BOOL (*TYPEFUNPTR)(BOOL, BOOL) REENTRANT;
...
void
callViaPtr2(ONEARGFUNPTR fptr, BOOL arg)
{
  (*fptr)(arg);
}
...
void
callViaPtr2Ansi(ONEARGFUNPTR fptr, BOOL arg)
{
  fptr(arg);
}
...
BOOL f_ret(BOOL arg1, BOOL arg2) REENTRANT
{
  BOOL local;
  local = !arg1;
  return (local & arg2);
...
__getSuiteName(void)
{
  return "cases\\t_funptrs_type_BOOL";
}
