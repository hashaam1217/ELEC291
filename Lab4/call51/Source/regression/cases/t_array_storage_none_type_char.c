...
const  unsigned char array_const_char[4] = {TC(0), TC(1), TC(2), TC(3)};
const  unsigned int  array_const_int [4] = {TI(0), TI(1), TI(2), TI(3)};
const  unsigned long array_const_long[4] = {TL(0), TL(1), TL(2), TL(3)};
...
__getSuiteName(void)
{
  return "cases\\t_array_storage_none_type_char";
}
