...
{
    volatile static unsigned long i, result;
...
{
    volatile static signed long i, result;
...
__getSuiteName(void)
{
  return "cases\\t_shifts_vals_3_storage_static_type_long_attr_volatile_sign_unsigned";
}
