/*
 * acconfig.h -- configuration definitions for gawk using MSVC.
 */
...
#define system(s) os_system(s)
// JCF: I am surprised gawk works at all!  Maybe the best thing to do is to remove
// any use of gawk from Call51...
// Disable warning: signed/unsigned mismatch
#pragma warning (disable : 4018)
// Disable warning: conversion from 'double ' to 'long ', possible loss of data
#pragma warning (disable : 4244)
// Disable warning: different 'const' qualifiers
#pragma warning (disable : 4090)
// Disable warning: pointer mismatch for actual parameter 1
#pragma warning (disable : 4022)
// Disable warning: unary minus operator applied to unsigned type, result still unsigned
#pragma warning (disable : 4146)
// Disable warning: formal parameter 1 different from declaration
#pragma warning (disable : 4028)
// Disable warning: unreferenced local variable
