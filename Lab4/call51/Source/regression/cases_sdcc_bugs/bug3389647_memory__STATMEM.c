...
_STATMEM char dummy = 0; /*prevent hid_report_descriptor to land at address 0 */
_STATMEM hid_report_descriptor HIDREPORTDESC =
{
...
unsigned char* DATAPTR1 = (_STATMEM unsigned char*)&HIDREPORTDESC;
unsigned char* DATAPTR2 = (         unsigned char*)&HIDREPORTDESC;

void testBug(void)
{
    unsigned char* DATAPTR3 = (_STATMEM unsigned char*)&HIDREPORTDESC;
...
__getSuiteName(void)
{
  return "cases_sdcc_bugs\\bug3389647_memory__STATMEM";
}
