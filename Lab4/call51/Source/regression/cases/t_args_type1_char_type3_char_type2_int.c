...
static char
returnFirstArg(char arg1, int arg2, char arg3)
{
    UNUSED(arg2);
    UNUSED(arg3);
    return arg1;
...
static int
returnSecondArg(char arg1, int arg2, char arg3)
{
    UNUSED(arg1);
    UNUSED(arg3);
    return arg2;
...
static char
returnThirdArg(char arg1, int arg2, char arg3)
{
    UNUSED(arg1);
    UNUSED(arg2);
    return arg3;
...
__getSuiteName(void)
{
  return "cases\\t_args_type1_char_type3_char_type2_int";
}
