...
unsigned long
sparseSwitch(unsigned long val)
{
  unsigned long ret;
  static volatile unsigned long local;
...
__getSuiteName(void)
{
  return "cases\\t_switch_storage_static_type_long_attr_volatile_sign_unsigned";
}
