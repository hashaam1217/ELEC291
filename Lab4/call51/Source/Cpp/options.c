...
const struct cl_option cl_options[] =
{
  ...
  { "-A",
    ...
    N_OPTS, 1, -1,
    CL_C51PP | CL_JOINED | CL_SEPARATE,
    0, CLVC_STRING, 0 },
  { "-C",
  ...
  { "-fexec-charset=",
    ...
    N_OPTS, 14, -1,
    CL_C51PP | CL_JOINED | CL_REJECT_NEGATIVE,
    0, CLVC_STRING, 0 },
  { "-finput-charset=",
  ...
  { "-ftabstop=",
    ...
    N_OPTS, 9, -1,
    CL_C51PP | CL_JOINED | CL_REJECT_NEGATIVE | CL_UINTEGER,
    0, CLVC_BOOLEAN, 0 },
  { "-funsigned-char",
