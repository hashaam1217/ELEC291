...
{
    volatile static signed int left, right;
...
{
    volatile static unsigned int left, right;

    left = 0;
    right = (unsigned int)-1;
...
__getSuiteName(void)
{
  return "cases\\t_compare_storage_static_type_int_attr_volatile";
}
