...
const __xdata unsigned char array_const_char[4] = {TC(0), TC(1), TC(2), TC(3)};
const __xdata unsigned int  array_const_int [4] = {TI(0), TI(1), TI(2), TI(3)};
const __xdata unsigned long array_const_long[4] = {TL(0), TL(1), TL(2), TL(3)};
...
__runSuite(void)
{
  __prints("Running testArrayAccess\n");
  testArrayAccess();
}
...
__getSuiteName(void)
{
  return "cases\\t_array_storage___xdata_type_char";
}
