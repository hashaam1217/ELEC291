...
{
    volatile static signed long left, right;
...
{
    volatile static unsigned long left, right;
...
__getSuiteName(void)
{
  return "cases\\t_compare_storage_static_type_long_attr_volatile";
}
