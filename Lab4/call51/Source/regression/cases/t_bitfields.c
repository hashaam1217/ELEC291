/** Bitfield tests.
  ...
  C51 pic16 port currently does not support bitfields of size > 8,
...
#endif  /* !C51_pic16 */
  /* Some C51 specific assertions. C51 uses 8 bit storage units.
