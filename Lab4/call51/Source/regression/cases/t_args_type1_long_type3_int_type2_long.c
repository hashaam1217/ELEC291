...
static long
returnFirstArg(long arg1, long arg2, int arg3)
{
    UNUSED(arg2);
    UNUSED(arg3);
    return arg1;
...
static long
returnSecondArg(long arg1, long arg2, int arg3)
{
    UNUSED(arg1);
    UNUSED(arg3);
    return arg2;
...
static int
returnThirdArg(long arg1, long arg2, int arg3)
{
    UNUSED(arg1);
    UNUSED(arg2);
    return arg3;
...
__getSuiteName(void)
{
  return "cases\\t_args_type1_long_type3_int_type2_long";
}
