...
; This file was generated Thu Jan 17 21:24:38 2013
;--------------------------------------------------------
$name gcc_torture_execute_20041019_1
$optc51 --model-small
	R_DSEG    segment data
	R_CSEG    segment code
	R_BSEG    segment bit
...
;--------------------------------------------------------
	...
	public _ftest_store_copy_prop
	public _ftest_store_ccp
	public _main
...
;--------------------------------------------------------
	rseg	R_OSEG
_ftest_store_ccp_a_1_73:
	ds 2
_ftest_store_ccp_b_1_73:
	ds 2
_ftest_store_ccp_c_1_73:
	ds 2
	rseg	R_OSEG
_ftest_store_copy_prop_a_1_75:
	ds 2
_ftest_store_copy_prop_b_1_75:
	ds 2
_ftest_store_copy_prop_c_1_75:
	ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	rseg R_DINIT
;	C:\Source\call51\Source\regression\cases_gcc\/../fwk/include/testfwk.h:20: int __numTests = 0;
	clr	a
	mov	___numTests,a
	mov	(___numTests + 1),a
;	C:\Source\call51\Source\regression\cases_gcc\/../fwk/include/testfwk.h:22: int __numFailures = 0;
	clr	a
...
;	C:\Source\call51\Source\regression\cases_gcc\/../fwk/include/testfwk.h:232: return 0;
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ftest_store_ccp'
;------------------------------------------------------------
;i                         Allocated to registers r2 r3 
;p                         Allocated to registers r4 r5 r6 
;a                         Allocated with name '_ftest_store_ccp_a_1_73'
;b                         Allocated with name '_ftest_store_ccp_b_1_73'
;c                         Allocated with name '_ftest_store_ccp_c_1_73'
;------------------------------------------------------------
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:11: ftest_store_ccp (int i)
;	-----------------------------------------
;	 function ftest_store_ccp
;	-----------------------------------------
_ftest_store_ccp:
	mov	r2,dpl
	mov	r3,dph
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:15: if (i < 5)
	clr	c
	mov	a,r2
	subb	a,#0x05
	mov	a,r3
	...
	subb	a,#0x80
	jnc	L008005?
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:16: p = &a;
	mov	r4,#_ftest_store_ccp_a_1_73
	mov	r5,#0x00
	mov	r6,#0x40
	sjmp	L008006?
L008005?:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:17: else if (i > 8)
	clr	c
	mov	a,#0x08
	subb	a,r2
	clr	a
	...
	subb	a,b
	jnc	L008002?
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:18: p = &b;
	mov	r4,#_ftest_store_ccp_b_1_73
	mov	r5,#0x00
	mov	r6,#0x40
	sjmp	L008006?
L008002?:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:20: p = &c;
	mov	r4,#_ftest_store_ccp_c_1_73
	mov	r5,#0x00
	mov	r6,#0x40
L008006?:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:22: *p = 10;
	mov	dpl,r4
	mov	dph,r5
	mov	b,r6
	mov	a,#0x0A
	...
	clr	a
	lcall	__gptrput
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:23: b = 3;
	mov	_ftest_store_ccp_b_1_73,#0x03
	clr	a
	mov	(_ftest_store_ccp_b_1_73 + 1),a
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:26: return *p + 2;
	mov	dpl,r4
	mov	dph,r5
	mov	b,r6
	lcall	__gptrget
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ftest_store_copy_prop'
;------------------------------------------------------------
;i                         Allocated to registers r2 r3 
;p                         Allocated to registers r4 r5 r6 
;a                         Allocated with name '_ftest_store_copy_prop_a_1_75'
;b                         Allocated with name '_ftest_store_copy_prop_b_1_75'
;c                         Allocated with name '_ftest_store_copy_prop_c_1_75'
;------------------------------------------------------------
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:30: ftest_store_copy_prop (int i)
;	-----------------------------------------
;	 function ftest_store_copy_prop
;	-----------------------------------------
_ftest_store_copy_prop:
	mov	r2,dpl
	mov	r3,dph
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:34: if (i < 5)
	clr	c
	mov	a,r2
	subb	a,#0x05
	mov	a,r3
	...
	subb	a,#0x80
	jnc	L009005?
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:35: p = &a;
	mov	r4,#_ftest_store_copy_prop_a_1_75
	mov	r5,#0x00
	mov	r6,#0x40
	sjmp	L009006?
L009005?:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:36: else if (i > 8)
	clr	c
	mov	a,#0x08
	subb	a,r2
	clr	a
	...
	subb	a,b
	jnc	L009002?
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:37: p = &b;
	mov	r4,#_ftest_store_copy_prop_b_1_75
	mov	r5,#0x00
	mov	r6,#0x40
	sjmp	L009006?
L009002?:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:39: p = &c;
	mov	r4,#_ftest_store_copy_prop_c_1_75
	mov	r5,#0x00
	mov	r6,#0x40
L009006?:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:41: *p = i;
	mov	dpl,r4
	mov	dph,r5
	mov	b,r6
	mov	a,r2
	...
	mov	a,r3
	lcall	__gptrput
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:42: b = i + 1;
	mov	a,#0x01
	add	a,r2
	mov	_ftest_store_copy_prop_b_1_75,a
	clr	a
	addc	a,r3
	mov	(_ftest_store_copy_prop_b_1_75 + 1),a
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:45: return *p;
	mov	dpl,r2
	mov	dph,r3
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:50: testTortureExecute (void)
;	-----------------------------------------
;	 function testTortureExecute
;	-----------------------------------------
_testTortureExecute:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:55: x = ftest_store_ccp (10);
	mov	dptr,#0x000A
	lcall	_ftest_store_ccp
	mov	r2,dpl
	mov	r3,dph
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:56: if (x == 12)
	cjne	r2,#0x0C,L010002?
	cjne	r3,#0x00,L010002?
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:57: ASSERT (0);
	inc	___numTests
	clr	a
...
L010011?:
	...
	mov	___fail_PARM_4,#0x39
	clr	a
	mov	(___fail_PARM_4 + 1),a
	mov	dptr,#__str_3
	lcall	___fail
L010002?:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:59: x = ftest_store_copy_prop (9);
	mov	dptr,#0x0009
	lcall	_ftest_store_copy_prop
	mov	r2,dpl
	mov	r3,dph
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:60: if (x == 9)
	cjne	r2,#0x09,L010004?
	cjne	r3,#0x00,L010004?
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:61: ASSERT (0);
	inc	___numTests
	clr	a
	cjne	a,___numTests,L010014?
	inc	(___numTests + 1)
L010014?:
	mov	___fail_PARM_2,#__str_4
	mov	(___fail_PARM_2 + 1),#(__str_4 >> 8)
	mov	___fail_PARM_3,#__str_5
	mov	(___fail_PARM_3 + 1),#(__str_5 >> 8)
	mov	___fail_PARM_4,#0x3D
	clr	a
	mov	(___fail_PARM_4 + 1),a
	mov	dptr,#__str_3
	lcall	___fail
L010004?:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:63: return;
	ret
;------------------------------------------------------------
;Allocation info for local variables in function '__runSuite'
;------------------------------------------------------------
;------------------------------------------------------------
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:68: __runSuite(void)
;	-----------------------------------------
;	 function __runSuite
;	-----------------------------------------
___runSuite:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:70: __prints("Running testTortureExecute\n");
	mov	dptr,#__str_6
	mov	b,#0x80
	lcall	___prints
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:71: testTortureExecute();
	ljmp	_testTortureExecute
;------------------------------------------------------------
;Allocation info for local variables in function '__getSuiteName'
;------------------------------------------------------------
;------------------------------------------------------------
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:77: __getSuiteName(void)
;	-----------------------------------------
;	 function __getSuiteName
;	-----------------------------------------
___getSuiteName:
;	C:\Source\call51\Source\regression\cases_gcc\gcc-torture-execute-20041019-1.c:79: return "cases_gcc\\gcc-torture-execute-20041019-1";
	mov	dptr,#__str_7
	ret
	rseg R_CSEG
...
__str_7:
	db 'cases_gcc'
	db 0x5C
	db 'gcc-torture-execute-20041019-1'
	db 0x00
