...
signed char
sparseSwitch(signed char val)
{
  signed char ret;
  static volatile signed char local;
...
__getSuiteName(void)
{
  return "cases\\t_switch_storage_static_type_char_attr_volatile_sign_signed";
}
