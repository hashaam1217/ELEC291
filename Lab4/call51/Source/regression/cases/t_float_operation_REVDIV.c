...
// Test for optimization bug in C51cse.c line 1081, near case '/':
void
testFloatDivOptimization (void)
{
	float a;
...
__runSuite(void)
{
  __prints("Running testFloatMath\n");
  testFloatMath();
  __prints("Running testFloatMulRound\n");
  testFloatMulRound();
  __prints("Running testFloatDivOptimization\n");
  testFloatDivOptimization();
}
...
__getSuiteName(void)
{
  return "cases\\t_float_operation_REVDIV";
}
