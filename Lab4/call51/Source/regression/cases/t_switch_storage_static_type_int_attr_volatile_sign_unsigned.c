...
unsigned int
sparseSwitch(unsigned int val)
{
  unsigned int ret;
  static volatile unsigned int local;
...
__getSuiteName(void)
{
  return "cases\\t_switch_storage_static_type_int_attr_volatile_sign_unsigned";
}
