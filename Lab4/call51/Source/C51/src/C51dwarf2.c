/*-------------------------------------------------------------------------
  C51dwarf2.c - generate DWARF2 debug information
...
int dwWriteModule(char *name)
{
    ...
    sprintf(verid, "C51 version %s #%s", C51_VERSION_STR, getBuildNumber());
