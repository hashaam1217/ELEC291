/*-------------------------------------------------------------------------
  C51symt.h - Header file for Symbols table related structures and MACRO's.
...
#define C51_SYMNAME_MAX 64
#define C51_NAME_MAX  3*C51_SYMNAME_MAX // big enough for _<func>_<var>_etc
#include "C51hasht.h"
#include "C51globl.h"
#include "dbuf.h"
...
typedef struct bucket
{
    ...
    char name[C51_NAME_MAX + 1];       /* name of this symbol        */
...
{
    char tag[C51_NAME_MAX + 1];        /* tag part of structure      */
...
{
    char name[C51_SYMNAME_MAX + 1];    /* Input Variable Name     */
    char rname[C51_NAME_MAX + 1];      /* internal name           */
