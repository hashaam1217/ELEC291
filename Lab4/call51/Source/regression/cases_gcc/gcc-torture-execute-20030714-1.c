/*
   20030714-1.c from the execute part of the gcc torture tests.
 */
...
struct RenderBox
{
  ...
  bool (*isTableCell) (struct RenderBox *this) __reentrant;
};
...
__getSuiteName(void)
{
  return "cases_gcc\\gcc-torture-execute-20030714-1";
}
