/*
===============================================================================
C51ERR - C51 Standard error handler


===============================================================================
*/

#if !defined(__C51ERR_H)
...
#define E_ISR_PROTOTYPE               197 /* Pointer target lost qualifier */
#define W_EMPTY_IF_STATEMENT          198 /* If with no statements */
#define E_BAD_DESIGNATOR              199 /* Bad designated initializer */
#define W_DUPLICATE_INIT              200 /* Duplicate initializer */
...
extern struct C51ERRG _C51ERRG;
