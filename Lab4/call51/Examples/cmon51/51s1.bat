:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: CrossIde support batch file for c51
::
@echo off
::
...
set COpt= --use-stdout --code-loc %CodeLoc% -DMONITOR_LOC=%CodeLoc%
set LOpt= --code-loc %CodeLoc% --code-size 0x2000 --xram-loc 0x200 --xram-size 0x100 %COpt%
set OOpt=obj
...
%Bin%\c51 %COpt% -c %2.c
if errorlevel 1 goto sdccerror
goto end
:sdccerror
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Link object files and libraries using c51
::
:dold
set tgt=%2
