/* C51globl.h - global macros etc required by all files */
...
/*
 * cloneOptimize function in C51.lex should be updated every time
...
/*
 * cloneOptions function in C51.lex should be updated every time
...
struct options
{
    ...
    int std_c51;                /* enable C51 extensions to C */
    int printf_float;           /* link with floating point enabled printf*/
	...
	char *overlay_to;           /* the name of the forced overlay segment */
    /* sets */
...
extern int NestLevel;           /* NestLevel                 C51.y */
extern int stackPtr;            /* stack pointer             C51.y */
extern int xstackPtr;           /* external stack pointer    C51.y */
extern int reentrant;           /* /X flag has been sent     C51.y */
extern char buffer[PATH_MAX * 2];/* general buffer           C51main.c */
extern int currRegBank;         /* register bank being used  C51gens.c */
extern int RegBankUsed[4];      /* JCF: register banks used  C51main.c */
extern int BitBankUsed;         /* MB: overlayable bit bank  C51main.c */
extern struct symbol *currFunc; /* current function    C51gens.c */
extern int cNestLevel;          /* block nest level  C51val.c */
...
/** An assert() macro that will go out through c51's error
    system.
*/
 ...
 * be trashed by any function call within C51.
 */
