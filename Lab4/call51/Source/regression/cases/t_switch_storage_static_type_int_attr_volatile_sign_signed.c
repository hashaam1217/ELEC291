...
signed int
sparseSwitch(signed int val)
{
  signed int ret;
  static volatile signed int local;
...
__getSuiteName(void)
{
  return "cases\\t_switch_storage_static_type_int_attr_volatile_sign_signed";
}
