...
spacesToUnderscores (char *dest, const char *src, size_t len)
{
    ...
    {
        *p++ = (isspace((unsigned char)*src) || (*src == '-') || (*src == '.')) ? '_' : *src;
    }
    *p = '\0';
...
void cdbTypeInfo (sym_link * type)
{
    ...
    while (type)
    {
        if (IS_DECL (type))
        {
            ...
            {
            case FUNCTION:
                fprintf (cdbFilePtr, "DF,");
                break;
            case GPOINTER:
                fprintf (cdbFilePtr, "DG,");
                break;
            case CPOINTER:
                fprintf (cdbFilePtr, "DC,");
                break;
            case FPOINTER:
                fprintf (cdbFilePtr, "DX,");
                break;
            case POINTER:
                fprintf (cdbFilePtr, "DD,");
                break;
            case IPOINTER:
                fprintf (cdbFilePtr, "DI,");
                break;
            case PPOINTER:
                fprintf (cdbFilePtr, "DP,");
                break;
            case EEPPOINTER:
                fprintf (cdbFilePtr, "DA,");
                break;
            case ARRAY:
                fprintf (cdbFilePtr, "DA%d,", DCL_ELEM (type));
                break;
            default:
                break;
            }
        ...
        else
        {
            ...
            case V_CHAR:
                fprintf (cdbFilePtr, "SC");
                break;
            case V_VOID:
                fprintf (cdbFilePtr, "SV");
                break;
            case V_FLOAT:
                fprintf (cdbFilePtr, "SF");
                break;
            case V_FIXED16X16:
                fprintf(cdbFilePtr, "SQ");
                break;
            case V_STRUCT:
