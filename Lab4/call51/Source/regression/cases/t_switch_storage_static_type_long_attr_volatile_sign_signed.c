...
signed long
sparseSwitch(signed long val)
{
  signed long ret;
  static volatile signed long local;
...
__getSuiteName(void)
{
  return "cases\\t_switch_storage_static_type_long_attr_volatile_sign_signed";
}
