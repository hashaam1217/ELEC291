...
{
    volatile static signed char left, right;
...
{
    volatile static unsigned char left, right;

    left = 0;
    right = (unsigned char)-1;
...
__getSuiteName(void)
{
  return "cases\\t_compare_storage_static_type_char_attr_volatile";
}
