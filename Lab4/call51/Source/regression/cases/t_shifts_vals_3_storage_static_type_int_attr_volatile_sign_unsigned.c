...
{
    volatile static unsigned int i, result;
...
{
    volatile static signed int i, result;
...
__getSuiteName(void)
{
  return "cases\\t_shifts_vals_3_storage_static_type_int_attr_volatile_sign_unsigned";
}
