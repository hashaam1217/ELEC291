...
; This file was generated Thu Dec 13 16:02:35 2012
;--------------------------------------------------------
$name bug2942343
$optc51 --model-small
	R_DSEG    segment data
...
;	C:\Source\call51\Source\regression\sdcc_bugs\bug2942343.c:9: unsigned char y[3] = {255, 256, 257}; //does not.
	mov	_y,#0xFF
	mov	(_y + 0x0001),#0x00
	mov	(_y + 0x0002),#0x01
;	C:\Source\call51\Source\regression\sdcc_bugs\bug2942343.c:12: _Bool bar[4] = {1, 2, 3, 4};          //creates an array with true in foo[0], but 2,3,4 in the rest.
	mov	_bar,#0x01
	mov	(_bar + 0x0001),#0x02
	mov	(_bar + 0x0002),#0x03
	mov	(_bar + 0x0003),#0x04
...
;------------------------------------------------------------
;------------------------------------------------------------
;	C:\Source\call51\Source\regression\sdcc_bugs\bug2942343.c:14: void testBug(void)
;	-----------------------------------------
;	 function testBug
;	-----------------------------------------
_testBug:
;	C:\Source\call51\Source\regression\sdcc_bugs\bug2942343.c:22: }
	ret
	rseg R_CSEG
