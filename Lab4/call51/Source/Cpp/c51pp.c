/*-------------------------------------------------------------------------
  c51ppmain.c - c51pp: C51 preprocessor main file, using cpplib.
...
/* From c-lang.c */
#define LANG_HOOKS_INIT_OPTIONS c51pp_init_options
#define LANG_HOOKS_HANDLE_OPTION c51pp_common_handle_option
#define LANG_HOOKS_MISSING_ARGUMENT c51pp_common_missing_argument
#define LANG_HOOKS_POST_OPTIONS c51pp_common_post_options
#define LANG_HOOKS_INIT c51pp_common_init
#define LANG_HOOKS_FINISH c51pp_common_finish

static unsigned int c51pp_init_options (unsigned int argc, const char **argv);
...
/* C51 specific
   c51_hash pragma */
static void
do_pragma_c51_hash (cpp_reader *pfile)
{
    ...
    else
    {
        cpp_error (pfile, CPP_DL_ERROR,
                   "invalid #pragma c51_hash directive, need '+' or '-'");
    }
}
...
static unsigned int
c51pp_init_options (unsigned int argc, const char **argv)
{
  unsigned int ret = c51pp_common_init_options(argc, argv);
  ...
  /* Kevin abuse for C51. */
  cpp_register_pragma(parse_in, 0, "c51_hash", do_pragma_c51_hash, false);
  /* C51 _asm specific */
  ...
  parse_in->spec_nodes.n__endasm = cpp_lookup (parse_in, DSC("_endasm"));
